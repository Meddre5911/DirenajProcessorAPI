package tr.edu.boun.cmpe.direnaj.processor.semantic.repositories.clients;
...
import tr.edu.boun.cmpe.direnaj.processor.semantic.parsing.WikiMetaExtractor;
...
import tr.edu.boun.cmpe.direnaj.processor.utils.JsonUtil;
...
public class FreeBaseClient {
	...
	private String fetchTopicDesc(String guid) throws IOException {
		return StringUtils.substringBetween(GeneralUtil.fetchSource(URL_RAW_CONTENT.concat(guid)), RAW_DESC_TAGS[0], RAW_DESC_TAGS[1]);
	}
