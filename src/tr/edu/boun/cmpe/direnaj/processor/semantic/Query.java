package tr.edu.boun.cmpe.direnaj.processor.semantic;
...
/**
 * FIXME burada kimi variable ve methodlar Burak'ýn çalýþmasýndaki DB'ye baðlý.
 * Direnaj'la uyumluluðu olmayan þeylerin Unit Test'lerde silinmesi
 */
public class Query {
	...
	public Query(int id, Date date, String query, String freebaseId,
			String freebaseType, int status) {
